...
# Define extract_line function (moved outside to be always available)
...
if not use_cached:
    ...
    for year in historical_years:
        ...
        # Elo ratings (season-level, but we'll use per-game from games for rolling)
    ...
    # Extract betting lines using the function
...
# Save trained models
dump(margin_model, 'margin_model.joblib')
dump(total_model, 'total_model.joblib')
